...
class _PlayerQueuePanel extends StatefulWidget {
  ...
  @override
  State<_PlayerQueuePanel> createState() => _PlayerQueuePanelState();
}

class _PlayerQueuePanelState extends State<_PlayerQueuePanel> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          margin: isPortrait
              ? const EdgeInsets.only(bottom: _collapsedHeight + 16.0)
              : null,
